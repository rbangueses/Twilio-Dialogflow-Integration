...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			...
			<pre><code><span style="color: #0000FF">var</span><span style="color: #000000"> { </span><span style="color: #001080">SyncClient</span><span style="color: #000000"> } = </span><span style="color: #795E26">require</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;twilio-sync&#039;</span><span style="color: #000000">);</span>
<span style="color: #0000FF">var</span><span style="color: #000000"> </span><span style="color: #001080">syncClient</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #795E26">SyncClient</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>
</code></pre>
			...
			<pre><code><span style="color: #000000">&lt;</span><span style="color: #001080">script</span><span style="color: #000000"> </span><span style="color: #001080">type</span><span style="color: #000000">=</span><span style="color: #A31515">&quot;text/javascript&quot;</span><span style="color: #000000"> </span><span style="color: #001080">src</span><span style="color: #000000">=</span><span style="color: #A31515">&quot;//media.twiliocdn.com/sdk/js/sync/v3.0/twilio-sync.min.js&quot;</span><span style="color: #000000">&gt;&lt;/</span><span style="color: #267F99">script</span><span style="color: #000000">&gt;</span>
</code></pre>
			<p>Using this method, twilio-sync.js will set a browser global:</p>
			<pre><code><span style="color: #0000FF">var</span><span style="color: #000000"> </span><span style="color: #001080">syncClient</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #001080">Twilio</span><span style="color: #000000">.</span><span style="color: #001080">Sync</span><span style="color: #000000">.</span><span style="color: #795E26">Client</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>
</code></pre>
...
<span style="color: #0000FF">var</span><span style="color: #000000"> </span><span style="color: #001080">token</span><span style="color: #000000"> = </span><span style="color: #A31515">&#039;&lt;your-access-token-here&gt;&#039;</span><span style="color: #000000">;</span>
<span style="color: #0000FF">var</span><span style="color: #000000"> </span><span style="color: #001080">syncClient</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #001080">Twilio</span><span style="color: #000000">.</span><span style="color: #001080">Sync</span><span style="color: #000000">.</span><span style="color: #795E26">Client</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>
...
<span style="color: #000000">    </span><span style="color: #0000FF">var</span><span style="color: #000000"> </span><span style="color: #001080">newData</span><span style="color: #000000"> = { </span><span style="color: #001080">temperature:</span><span style="color: #000000"> </span><span style="color: #098658">23</span><span style="color: #000000"> };</span>
