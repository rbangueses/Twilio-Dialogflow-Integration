...
<head>
	...
	<title>OpenOptions | twilio-sync</title>
		...
		<li class="current tsd-kind-interface">
			...
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="OpenOptions.html#id" class="tsd-kind-icon">id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="OpenOptions.html#mode" class="tsd-kind-icon">mode</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="OpenOptions.html#ttl" class="tsd-kind-icon">ttl</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-interface">
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Options for opening a Sync object.</p>
				</div>
				<dl class="tsd-comment-tags">
					<dt>example</dt>
					<dd><p>The following example is applicable to all Sync objects
						(i.e., <code>syncClient.document()</code>, <code>syncClient.list()</code>,<code> syncClient.map()</code>, <code>syncClient.stream()</code>)</p>
						<pre><code class="language-typescript"><span style="color: #008000">// Attempts to open an existing document with a unique name of &#039;MyDocument&#039;</span>
<span style="color: #008000">// If no such document exists, the promise is rejected</span>
<span style="color: #001080">syncClient</span><span style="color: #000000">.</span><span style="color: #795E26">document</span><span style="color: #000000">({</span>
<span style="color: #000000">  </span><span style="color: #001080">id:</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;MyDocument&#039;</span><span style="color: #000000">,</span>
<span style="color: #000000">  </span><span style="color: #001080">mode:</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;open_existing&#039;</span>
<span style="color: #000000">})</span>
<span style="color: #000000">  .</span><span style="color: #795E26">then</span><span style="color: #000000">(...)</span>
<span style="color: #000000">  .</span><span style="color: #795E26">catch</span><span style="color: #000000">(...);</span>

<span style="color: #008000">// Attempts to create a new document with a unique name of &#039;MyDocument&#039;, TTL of 24 hours and initial data `{ name: &#039;John Smith&#039; }`</span>
<span style="color: #008000">// If such a document already exists, the promise is rejected</span>
<span style="color: #001080">syncClient</span><span style="color: #000000">.</span><span style="color: #795E26">document</span><span style="color: #000000">({</span>
<span style="color: #000000">  </span><span style="color: #001080">id:</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;MyDocument&#039;</span><span style="color: #000000">,</span>
<span style="color: #000000">  </span><span style="color: #001080">mode:</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;create_new&#039;</span><span style="color: #000000">,</span>
<span style="color: #000000">  </span><span style="color: #001080">ttl:</span><span style="color: #000000"> </span><span style="color: #098658">86400</span>
<span style="color: #000000">  </span><span style="color: #001080">data</span><span style="color: #000000">: { </span><span style="color: #001080">name:</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;John Smith&#039;</span><span style="color: #000000"> } </span><span style="color: #008000">// the `data` property is only applicable for Documents</span>
<span style="color: #000000">})</span>
<span style="color: #000000">  .</span><span style="color: #795E26">then</span><span style="color: #000000">(...)</span>
<span style="color: #000000">  .</span><span style="color: #795E26">catch</span><span style="color: #000000">(...);</span>
</code></pre>
		...
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					...
					<ul class="tsd-hierarchy">
						<li>
							<a href="OpenDocumentOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">OpenDocumentOptions</a>
						</li>
						<li>
							<a href="OpenListOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">OpenListOptions</a>
						</li>
						<li>
							<a href="OpenMapOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">OpenMapOptions</a>
						</li>
						<li>
							<a href="OpenStreamOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">OpenStreamOptions</a>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="OpenOptions.html#id" class="tsd-kind-icon">id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="OpenOptions.html#mode" class="tsd-kind-icon">mode</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="OpenOptions.html#ttl" class="tsd-kind-icon">ttl</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Sync object SID or unique name.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">mode<span class="tsd-signature-symbol">:</span> <a href="../modules.html#OpenMode" class="tsd-signature-type" data-tsd-kind="Type alias">OpenMode</a></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The time-to-live of the Sync object in seconds. This is applied only if the object is created.</p>
					</div>
				</div>
			</section>
		</section>
