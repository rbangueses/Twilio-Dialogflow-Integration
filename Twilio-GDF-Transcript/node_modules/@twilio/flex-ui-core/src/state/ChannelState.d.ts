 ...
 * @property {Member} source - Represents the remote client in a Channel. See structure here: {@link https://media.twiliocdn.com/sdk/js/chat/releases/3.4.0/docs/Member.html}
 ...
 * @property {Message} source - Represents the message object. See structure here: {@link https://media.twiliocdn.com/sdk/js/chat/releases/3.4.0/docs/Message.html}
 ...
 * @property {Paginator} [currentPaginator] Paginator class to request messages on previous or next pages. See structure here: {@link https://media.twiliocdn.com/sdk/js/chat/releases/3.4.0/docs/Paginator.html}
 ...
 * @property {Channel} [source] Reference to the channel. See structure here: {@link https://media.twiliocdn.com/sdk/js/chat/releases/3.4.0/docs/Channel.html}
