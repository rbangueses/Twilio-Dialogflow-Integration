...
import { WebpackType, WebpackConfigurations, WebpackDevConfigurations } from '@twilio/flex-plugin-webpack';
 ...
 */
declare const getConfiguration: <T extends ConfigurationType>(name: T, env: Environment, emitErrors: boolean, type?: WebpackType) => Promise<Configurations[T]>;
