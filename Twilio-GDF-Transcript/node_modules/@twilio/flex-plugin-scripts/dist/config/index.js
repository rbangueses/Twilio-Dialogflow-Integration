 ...
 */
var getConfiguration = function (name, env, emitErrors, type) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(name === ConfigurationType.Webpack)) return [3 /*break*/, 7];
                    config = flex_plugin_webpack_1.webpackFactory(env, type);
                    if (type === flex_plugin_webpack_1.WebpackType.Static) {
                        return [2 /*return*/, config];
                    }
                    if (!fs_1.checkFilesExist(fs_1.getPaths().app.webpackConfigPath)) return [3 /*break*/, 6];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 2, , 6]);
                ...
                case 2:
                    exception_1 = _a.sent();
                    if (!emitErrors) return [3 /*break*/, 4];
                    return [4 /*yield*/, flex_plugin_webpack_1.emitDevServerCrashed(exception_1)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4: throw exception_1;
                case 5: return [3 /*break*/, 6];
                case 6: return [2 /*return*/, config];
                case 7:
                    if (!(name === ConfigurationType.DevServer)) return [3 /*break*/, 12];
                    config = flex_plugin_webpack_1.webpackDevFactory(type);
                    if (type === flex_plugin_webpack_1.WebpackType.Static) {
                        return [2 /*return*/, config];
                    }
                    if (!fs_1.checkFilesExist(fs_1.getPaths().app.devServerConfigPath)) return [3 /*break*/, 11];
                    _a.label = 8;
                case 8:
                    _a.trys.push([8, 9, , 11]);
                ...
                case 10:
                    _a.sent();
                    return [3 /*break*/, 11];
                case 11: return [2 /*return*/, config];
                case 12:
