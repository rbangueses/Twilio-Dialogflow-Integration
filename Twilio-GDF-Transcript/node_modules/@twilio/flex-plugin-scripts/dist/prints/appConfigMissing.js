...
exports.default = (function () {
    ...
    var scriptName = nameColor('@twilio/flex-plugin-scripts');
    ...
    flex_dev_utils_1.logger.newline();
    flex_dev_utils_1.logger.info(flex_dev_utils_1.singleLineString("Check your " + link('public/') + " directory for " + link('appConfig.example.js') + ",", "copy it to " + link('appConfig.js') + ", and modify your Account Sid and Service URL."));
    flex_dev_utils_1.logger.newline();
