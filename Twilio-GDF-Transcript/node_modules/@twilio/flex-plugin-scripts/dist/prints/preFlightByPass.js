...
exports.default = (function (skip) {
    ...
    if (skip) {
        ...
        flex_dev_utils_1.logger.warning(flex_dev_utils_1.multilineString('If you like to skip this and proceed anyway, use SKIP_PREFLIGHT_CHECK=true environment variable.', 'This will disable checks and allow you to run your application.'));
    }
