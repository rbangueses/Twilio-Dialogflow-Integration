...
exports.default = (function (count) {
    ...
    flex_dev_utils_1.logger.info(flex_dev_utils_1.singleLineString("There are " + bold(count.toString()) + " plugin(s) being loaded in this source code.", "Check that the " + bold('src/index') + " file contains only one call to", bold('FlexPlugin.loadPlugin(...)') + ".", "For more information, please refer to " + link('https://www.twilio.com/docs/flex/plugins') + "."));
    flex_dev_utils_1.logger.newline();
