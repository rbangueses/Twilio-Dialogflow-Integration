...
exports.default = (function (flexUIVersion, packageName, version, skip) {
    ...
    flex_dev_utils_1.logger.newline();
    flex_dev_utils_1.logger.info(flex_dev_utils_1.singleLineString("However, unbundled React is only supported with " + flexUIName + " version higher than ", minFlexUIVersion + ". You are currently running:"));
    flex_dev_utils_1.logger.newline();
