...
exports.default = (function (url, isPublic, account) {
    ...
    flex_dev_utils_1.logger.success(flex_dev_utils_1.singleLineString('🚀  Your plugin has been successfully deployed to your Flex project', "" + nameLogger(friendlyName) + accountSid + ".", "It is hosted (" + availability + ") as a Twilio Asset on " + flex_dev_utils_1.logger.coloredStrings.link(url) + "."));
    flex_dev_utils_1.logger.newline();
});
